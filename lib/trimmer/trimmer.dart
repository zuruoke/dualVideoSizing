...
import 'package:reminisce/trimmer/storage_dir.dart';
import 'package:reminisce/utils/size_video.dart';
...
class Trimmer {
  ...
  Map<String, dynamic> _videoParams = {};

  double? get videoHeight => _videoParams['height'];

  double? get videoWidth => _videoParams['width'];
